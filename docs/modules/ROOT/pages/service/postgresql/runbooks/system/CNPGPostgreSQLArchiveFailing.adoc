...
Failing archiving puts point-in-time recovery (PITR) and backups at risk. If archiving fails long enough, WAL segments may be recycled before they are archived.
