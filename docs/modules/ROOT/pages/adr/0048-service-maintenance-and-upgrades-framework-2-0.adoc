= ADR 0048 - Service Maintenance and Upgrades (Framework 2.0)
...
:adr_upd_date:
:adr_status: draft
:adr_tags: framework,framework2,maintenance,upgrades,crossplane
...
.Summary
====
The decision selects Kubernetes native CronJobs to orchestrate maintenance and upgrades with possible use of ArgoCD Workflows or Crossplane CronOperations in the future in case of growing complexity.
====
