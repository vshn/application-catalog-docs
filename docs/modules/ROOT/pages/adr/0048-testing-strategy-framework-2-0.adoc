= ADR 0050 - Testing Strategy (Framework 2.0)
...
.Summary
====
Use a four-layer testing strategy: Go unit tests, Crossplane beta renderer diffs, Chainsaw end-to-end tests on ephemeral clusters before release/tag, and targeted golden tests for critical paths.
====
