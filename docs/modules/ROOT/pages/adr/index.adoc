...
|xref:adr/0045-configuration-language-kcl-vs-cue.adoc[]

`framework,framework2,kcl,cue`
|draft | |
|xref:adr/0046-service-orchestration-crossplane-2-0.adoc[]

`framework,framework2,crossplane,composition`
|draft | |
|xref:adr/0047-secret-management-framework-2-0.adoc[]

`framework,framework2,secrets`
|draft | |
|xref:adr/0048-cost-tracking-and-billing-framework-2-0.adoc[]

`framework,framework2,billing,odoo`
|draft | |
|xref:adr/0049-service-maintenance-and-upgrades-framework-2-0.adoc[]

`framework,framework2,maintenance,upgrades`
|draft | |
|xref:adr/0050-testing-strategy-framework-2-0.adoc[]
