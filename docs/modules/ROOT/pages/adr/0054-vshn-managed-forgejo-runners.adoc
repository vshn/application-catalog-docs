...
The https://codeberg.org/wrenix/helm-charts[`oci://codeberg.org/wrenix/helm-charts/forgejo-runner`] chart is used to deploy the runner and was already used in the PoC.
...
NOTE: The chart maintainer notes they have switched to Woodpecker CI and may not test every change.
This is worth keeping in mind for future upgrades.
