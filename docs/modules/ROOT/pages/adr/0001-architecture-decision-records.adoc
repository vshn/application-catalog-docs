...
.Summary
====
Architecture Decision Records (ADR) are our way to document decisions, ideas, architecture and other important aspects of the engineering process.
It helps us to understand the "why".
====
...
We will write ADRs to document our decisions on the architecture, processes and tools.
