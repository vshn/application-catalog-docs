= ADR 0049 - Alternatives to Minio for S3 compatible Object Storage
...
AppCat is about how it could get integrated into AppCat.
...
Because there's deep integration into AppCat itself it will usually not be a self-service product.
