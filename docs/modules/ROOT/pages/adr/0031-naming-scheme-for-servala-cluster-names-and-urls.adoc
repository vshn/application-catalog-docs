...
The apps domain for the services should be: `*.apps.[csp]-[region]-[stage][counter].services.servala.com`
...
`*.apps.cloudscale-rma1-prod1.services.servala.com`
* Third test service-cluster running on Exoscale in the ch-dk-2 region:
`*.apps.exoscale-ch-dk-2-test2.services.servala.com`
