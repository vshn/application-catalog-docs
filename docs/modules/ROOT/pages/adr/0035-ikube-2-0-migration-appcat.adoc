...
.Summary
====
This ADR compares various strategies how we want to handle the migration to iKube 2.0.
The opportinity is used to address a few pain points we have with the current setup.
...
* We completely change how we deploy SPSK changes and add a lot more automation
