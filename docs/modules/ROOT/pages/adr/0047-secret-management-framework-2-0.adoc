= ADR 0047 - Secret Management (Framework 2.0)
...
:adr_upd_date:
:adr_status: draft
:adr_tags: framework,framework2,secrets,crossplane
...
.Summary
====
The decision selects Crossplane 2.0 Connection Secret as connection credentials
====
