...
Some companies such as https://opensource.google/documentation/reference/using/agpl-policy[Google] categorically avoid any software licensed under AGPL as it is fairly restricitve and may force you to release you're own code under the AGPL license.
