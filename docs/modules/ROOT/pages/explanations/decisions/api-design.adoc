...
This decision is about how to define "a common look" as mentioned https://kb.vshn.ch/app-catalog/explanations/why_exists.html#_standard_way_to_provide_services[here].
