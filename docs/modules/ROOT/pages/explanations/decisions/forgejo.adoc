...
A instance of Codey has to be ordered via the Codey website and is running on pre-defined "black-box" OpenShift OKE service clusters to which the customer doesn't have access to.
...
See <<_forgejo_by_vshn, default Helm values>>.
