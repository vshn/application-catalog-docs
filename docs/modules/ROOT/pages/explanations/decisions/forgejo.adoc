...
Database::
We'll use https://forgejo.org/docs/latest/admin/command-line/#dump[`forgejo dump`] as a https://docs.k8up.io/k8up/2.11/how-tos/application-aware-backups.html[backup command^] for K8up.
