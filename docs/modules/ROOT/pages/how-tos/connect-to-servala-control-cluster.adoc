...
== Use the servala-kubeconfigs repository

Clone https://github.com/vshn/servala-kubeconfigs locally and simply `cd` into the folder that corresponds with the control plane you want to connect to.
`direnv` will handle the rest.

== Craft a new kubeconfig
