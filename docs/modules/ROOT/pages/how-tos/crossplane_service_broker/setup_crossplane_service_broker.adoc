      ...
      containers:
        - name: service-broker
          ...
          env: # <4>
            ...
            - # Only enable this if plan upgrades are spcifically supported
              name: OSB_ALLOW_PLAN_UPGRADES
              value: "true"
          resources:
            limits:
              cpu: 500m
...
| `OSB_ALLOW_PLAN_UPGRADES`
| Whether to allow the Crossplane Service Broker to upgrade plans of service instances.
  The service broker will only allow increasing plan sizes or switching between SLAs.
